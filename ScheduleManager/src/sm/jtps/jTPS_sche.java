 ...
 */
public class jTPS_sche {
    private List<jTPS_sche_Transaction> transactions;
    ...
    public List<jTPS_sche_Transaction> getTransactions(){
        return transactions;
    }
    ...
    public void setTransactions(List<jTPS_sche_Transaction> transactions){
    ...
    public void addTransaction(jTPS_sche_Transaction transaction) {
    ...
    public void doTransaction() {
        if (mostRecentTransaction < (transactions.size()-1)) {
            jTPS_sche_Transaction transaction = transactions.get(mostRecentTransaction+1);
    ...
    public void undoTransaction() {
        if (mostRecentTransaction >= 0) {
            jTPS_sche_Transaction transaction = transactions.get(mostRecentTransaction);
    ...
    public String toString() {
        ...
        for (int i = 0; i <= mostRecentTransaction; i++) {
            jTPS_sche_Transaction jT = transactions.get(i);
            text += "----" + jT.toString() + "\n";
        }
        return text;
    }
